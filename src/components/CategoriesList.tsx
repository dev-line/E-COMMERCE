        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header border-0">
              <h5 className="modal-title font-weight-semi-bold" id="editCategory">Modification de catégorie</h5>
            </div>
            <div className="modal-body">
                <div className="mb-2"><span className="small font-weight-bold">Nom de catégorie</span></div>
            ...
            <div className="modal-footer border-0">
              ...
              <button type="button" className="btn btn-sm btn-secondary-f text-white" onClick={()=>{Edit(Categorie.id,Name)}}>sauvegarder</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body px-3">
              <div className="pt-5 text-center">
                ...
                <h4 className="font-weight-bold mt-5 mb-3">Supprimer la catégorie</h4>
                <p className="mb-1 w-80 mx-auto">Une fois cette catégorie supprimée, elle ne peut pas être restaurée.</p>
                <p className="font-weight-semi-bold mb-0">Etes-vous sûr que vous voulez continuer?</p>
              </div>
            </div>
            <div className="modal-footer border-0">
              <button type="button" className="btn btn-sm text-muted font-weight-semi-bold" data-dismiss="modal">Annuler</button>
              <button type="button" className="btn btn-sm btn-danger-f text-white font-weight-semi-bold" onClick={()=>{Remove(Categorie.id)}}>Supprimé</button>
            </div>
          </div>
        </div>
      </div>
